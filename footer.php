		...
		<footer id="contact" class="footer">
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 footer__sm-info">
						<p class="footer__sm-info__title title">SHAWN MATHEW</p>
					...
					<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 footer__contact">
						...
						<?php echo do_shortcode('[contact-form-7 id="99" title="Footer Contact"]'); ?>
					</div>
				</div>
			</div>			
		</footer>		
